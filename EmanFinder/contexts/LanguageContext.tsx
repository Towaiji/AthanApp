...
const translations = {
  english: {
    ...
    waterRelief: 'Water Relief',
    educationSupport: 'Education Support',
    selectGroup: 'Select Group',
    reliefAid: 'Relief Aid',
  ...
  urdu: {
    ...
    waterRelief: 'پانی کی امداد',
    educationSupport: 'تعلیمی مدد',
    selectGroup: 'گروپ منتخب کریں',
    reliefAid: 'امدادی معاونت',
  ...
  french: {
    ...
    waterRelief: 'Secours eau',
    educationSupport: "Soutien à l'éducation",
    selectGroup: 'Choisir un groupe',
    reliefAid: 'Aide humanitaire',
  ...
  turkish: {
    ...
    waterRelief: 'Su Yardımı',
    educationSupport: 'Eğitim Desteği',
    selectGroup: 'Grup Seç',
    reliefAid: 'Yardım Desteği',
    communitySupport: 'Toplumsal Destek',
    current: 'Güncel',
  },
} as const;
