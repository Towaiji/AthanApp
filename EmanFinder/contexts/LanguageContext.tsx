...
export type Language = 'english' | 'arabic' | 'urdu' | 'french' | 'turkish' | 'spanish';
...
const translations = {
  ...
  french: {
    ...
    dailyHadith: 'Hadith quotidien',
    hadithOfDay: 'Hadith du jour',
    anotherHadith: 'Hadith suivant',
    current: 'Actuelle',
  },
  turkish: {
    settings: 'Ayarlar',
    ...
    hadithOfDay: 'Günün Hadisi',
    anotherHadith: 'Sonraki Hadis',
    current: 'Güncel',
  },
  spanish: {
    ...
    prayerCalculation: 'Cálculo de la oración',
    ...
    todaysPrayerTimes: 'Tiempos de oración de hoy',
    remaining: 'restante',
    loadingPrayerTimes: 'Cargando tiempos de oración...',
